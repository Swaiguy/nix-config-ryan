...

{
  ...
  boot.initrd = {
    ...
    luks.devices."crypted-nixos" = {
      ...
      device = "/dev/disk/by-uuid/1a24deb0-c49b-46dc-874e-80c908fe8098";
  ...
  fileSystems."/btr_pool" = {
    device = "/dev/disk/by-uuid/42fc5ddb-5644-4b89-b4dc-e0c4cc191d4d";
    fsType = "btrfs";
  ...
  fileSystems."/boot" = {
    device = "/dev/disk/by-uuid/7576-4247";
    fsType = "vfat";
  };
